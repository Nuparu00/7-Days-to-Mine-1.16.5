...
public class GuiMainMenuEnhanced extends MainMenuScreen {
	...
	//public static final SimpleSound MENU_DEFAULT = SimpleSound.forMusic(ModSounds.MENU_DEFAULT.get());
	public static final BackgroundMusicSelector MENU_DEFAULT = new BackgroundMusicSelector(ModSounds.MENU_DEFAULT.get(), 40, 70, true);
...
/*
	...
	public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
		...
		if ((l & -67108864) != 0) {
			...
			for(int ii = 0; ii < this.buttons.size(); ++ii) {
				this.buttons.get(ii).render(matrixStack, mouseX, mouseY, partialTicks);
			}
