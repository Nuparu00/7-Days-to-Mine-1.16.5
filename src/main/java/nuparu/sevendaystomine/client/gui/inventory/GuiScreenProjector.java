...
@OnlyIn(Dist.CLIENT)
public class GuiScreenProjector extends ContainerScreen<ContainerScreenProjector> {
	...
	ContainerScreenProjector container;

	public GuiScreenProjector(ContainerScreenProjector container, PlayerInventory playerInventory, ITextComponent title) {
	...
	protected void renderLabels(MatrixStack matrixStack, int mouseX, int mouseY) {
		...
		this.font.draw(matrixStack, this.title, 58, 38, Color.darkGray.getRGB()); /// this.font.draw
