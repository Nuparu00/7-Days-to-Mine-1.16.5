...
@OnlyIn(Dist.CLIENT)
public class GuiCameraContainer extends ContainerScreen<ContainerCamera> {
	...
	public GuiCameraContainer(ContainerCamera container, PlayerInventory playerInventory, ITextComponent title) {
