...
@OnlyIn(Dist.CLIENT)
public class GuiCookingPot extends ContainerScreen<ContainerCookingPot> {
	...
	ContainerCookingPot container;

	public GuiCookingPot(ContainerCookingPot container, PlayerInventory playerInventory, ITextComponent title) {
	...
	protected void renderBg(MatrixStack matrixStack, float partialTicks, int x, int y) {
		...
		this.blit(matrixStack, marginHorizontal + 89, marginVertical + 36, 176, 14, progressLevel + 1, 16);
		double burnRemaining = container.cookingPot.isBurning() ? 1 : 0;
