...
@OnlyIn(Dist.CLIENT)
public class GuiSmallContainer extends ContainerScreen<ContainerSmall> {
	...
	public GuiSmallContainer(ContainerSmall container, PlayerInventory playerInventory, ITextComponent title) {
