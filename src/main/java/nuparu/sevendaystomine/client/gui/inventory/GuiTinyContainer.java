...
@OnlyIn(Dist.CLIENT)
public class GuiTinyContainer extends ContainerScreen<ContainerTiny> {
	...
	ContainerTiny container;

	public GuiTinyContainer(ContainerTiny container, PlayerInventory playerInventory, ITextComponent title) {
