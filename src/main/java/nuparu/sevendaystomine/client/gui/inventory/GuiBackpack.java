...
@OnlyIn(Dist.CLIENT)
public class GuiBackpack extends ContainerScreen<ContainerBackpack> {
	...
	public GuiBackpack(ContainerBackpack container, PlayerInventory playerInventory, ITextComponent title) {
