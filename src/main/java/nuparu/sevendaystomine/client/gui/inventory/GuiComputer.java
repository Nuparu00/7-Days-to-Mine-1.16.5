...
@OnlyIn(Dist.CLIENT)
public class GuiComputer extends ContainerScreen<ContainerComputer> {
	...
	ContainerComputer container;

	public GuiComputer(ContainerComputer container, PlayerInventory playerInventory, ITextComponent title) {
