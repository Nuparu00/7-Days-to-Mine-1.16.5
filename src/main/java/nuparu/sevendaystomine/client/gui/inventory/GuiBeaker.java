...
@OnlyIn(Dist.CLIENT)
public class GuiBeaker extends ContainerScreen<ContainerBeaker> {
	...
	ContainerBeaker container;

	public GuiBeaker(ContainerBeaker container, PlayerInventory playerInventory, ITextComponent title) {
	...
	protected void renderBg(MatrixStack matrixStack, float partialTicks, int x, int y) {
		...
		double burnRemaining = container.beaker.isBurning() ? 1 : 0;
