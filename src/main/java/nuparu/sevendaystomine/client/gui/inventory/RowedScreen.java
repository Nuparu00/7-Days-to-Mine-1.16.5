...
public class RowedScreen extends ContainerScreen<RowedContainer> implements IHasContainer<RowedContainer> {
    private static final ResourceLocation CONTAINER_BACKGROUND = new ResourceLocation("textures/gui/container/generic_54.png");
    private final int containerRows;

    public RowedScreen(RowedContainer p_i51095_1_, PlayerInventory p_i51095_2_, ITextComponent p_i51095_3_) {
