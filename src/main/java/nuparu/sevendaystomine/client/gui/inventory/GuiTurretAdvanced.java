...
@OnlyIn(Dist.CLIENT)
public class GuiTurretAdvanced extends ContainerScreen<ContainerTurretAdvanced> {
	...
	ContainerTurretAdvanced container;

	public GuiTurretAdvanced(ContainerTurretAdvanced container, PlayerInventory playerInventory, ITextComponent title) {
