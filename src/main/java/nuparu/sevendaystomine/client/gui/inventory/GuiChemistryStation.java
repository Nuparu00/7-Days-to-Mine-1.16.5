...
@OnlyIn(Dist.CLIENT)
public class GuiChemistryStation extends ContainerScreen<ContainerChemistryStation> {
	...
	public GuiChemistryStation(ContainerChemistryStation container, PlayerInventory playerInventory, ITextComponent title) {
