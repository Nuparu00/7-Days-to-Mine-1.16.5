...
public class SurvivorRenderer extends LivingRenderer<SurvivorEntity, PlayerModel<SurvivorEntity>> {
    public SurvivorRenderer(EntityRendererManager p_i46102_1_) {
        this(p_i46102_1_, false);
    }

    public SurvivorRenderer(EntityRendererManager p_i46103_1_, boolean p_i46103_2_) {
    ...
    public void render(SurvivorEntity p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
        this.setModelProperties(p_225623_1_);
        super.render(p_225623_1_, p_225623_2_, p_225623_3_, p_225623_4_, p_225623_5_, p_225623_6_);
}

    public Vector3d getRenderOffset(SurvivorEntity p_225627_1_, float p_225627_2_) {
        return p_225627_1_.isCrouching() ? new Vector3d(0.0D, -0.125D, 0.0D) : super.getRenderOffset(p_225627_1_, p_225627_2_);
    }

    private void setModelProperties(SurvivorEntity p_177137_1_) {
        PlayerModel<SurvivorEntity> playermodel = this.getModel();
    ...
    private static BipedModel.ArmPose getArmPose(SurvivorEntity p_241741_0_, Hand p_241741_1_) {
    ...
    public ResourceLocation getTextureLocation(SurvivorEntity survivorEntity) {
        return survivorEntity.getRes();
    }

    protected void scale(SurvivorEntity p_225620_1_, MatrixStack p_225620_2_, float p_225620_3_) {
        float f = 0.9375F;
        p_225620_2_.scale(0.9375F, 0.9375F, 0.9375F);
    }

    protected void renderNameTag(SurvivorEntity p_225629_1_, ITextComponent p_225629_2_, MatrixStack p_225629_3_, IRenderTypeBuffer p_225629_4_, int p_225629_5_) {
    ...
    public void renderRightHand(MatrixStack p_229144_1_, IRenderTypeBuffer p_229144_2_, int p_229144_3_, SurvivorEntity p_229144_4_) {
        this.renderHand(p_229144_1_, p_229144_2_, p_229144_3_, p_229144_4_, (this.model).rightArm, (this.model).rightSleeve);
    }

    public void renderLeftHand(MatrixStack p_229146_1_, IRenderTypeBuffer p_229146_2_, int p_229146_3_, SurvivorEntity p_229146_4_) {
        this.renderHand(p_229146_1_, p_229146_2_, p_229146_3_, p_229146_4_, (this.model).leftArm, (this.model).leftSleeve);
    }

    private void renderHand(MatrixStack p_229145_1_, IRenderTypeBuffer p_229145_2_, int p_229145_3_, SurvivorEntity p_229145_4_, ModelRenderer p_229145_5_, ModelRenderer p_229145_6_) {
        PlayerModel<SurvivorEntity> playermodel = this.getModel();
        ...
        p_229145_5_.render(p_229145_1_, p_229145_2_.getBuffer(RenderType.entitySolid(p_229145_4_.getRes())), p_229145_3_, OverlayTexture.NO_OVERLAY);
        p_229145_6_.xRot = 0.0F;
        p_229145_6_.render(p_229145_1_, p_229145_2_.getBuffer(RenderType.entityTranslucent(p_229145_4_.getRes())), p_229145_3_, OverlayTexture.NO_OVERLAY);
    }

    protected void setupRotations(SurvivorEntity p_225621_1_, MatrixStack p_225621_2_, float p_225621_3_, float p_225621_4_, float p_225621_5_) {
    ...
    public static class RenderFactory implements IRenderFactory<SurvivorEntity> {
        ...
        @Override
        public EntityRenderer<? super SurvivorEntity> createRenderFor(EntityRendererManager manager) {
            return new SurvivorRenderer(manager);
        }
    }
}
