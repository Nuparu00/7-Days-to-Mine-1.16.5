...
public class PlaguedNurseRenderer<T extends PlaguedNurseEntity, M extends BipedModel<T>>
	...
	private static final ResourceLocation ZOMBIE_LOCATION = new ResourceLocation(SevenDaysToMine.MODID,
			"textures/entity/plagued_nurse.png");

	public PlaguedNurseRenderer(EntityRendererManager manager) {
		super(manager);
	}
	...
	public static class RenderFactory implements IRenderFactory<PlaguedNurseEntity> {
		...
		@Override
		public EntityRenderer<? super PlaguedNurseEntity> createRenderFor(EntityRendererManager manager) {
			return new PlaguedNurseRenderer(manager);
		}
	}
}
