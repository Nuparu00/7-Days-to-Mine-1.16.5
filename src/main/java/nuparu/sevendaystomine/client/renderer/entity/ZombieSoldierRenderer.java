...
public class ZombieSoldierRenderer<T extends ZombieSoldierEntity, M extends BipedModel<T>>
	...
	private static final ResourceLocation ZOMBIE_LOCATION = new ResourceLocation(SevenDaysToMine.MODID,
			"textures/entity/zombie_soldier.png");

	public ZombieSoldierRenderer(EntityRendererManager manager) {
		super(manager);
	}
	...
	public static class RenderFactory implements IRenderFactory<ZombieSoldierEntity> {
		...
		@Override
		public EntityRenderer<? super ZombieSoldierEntity> createRenderFor(EntityRendererManager manager) {
			return new ZombieSoldierRenderer(manager);
		}
	}
}
