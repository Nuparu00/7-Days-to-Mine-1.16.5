...
public class ClothingLayer<T extends LivingEntity, M extends BipedModel<T>, A extends BipedModel<T>> extends LayerRenderer<T, M> {
    ...
    public ClothingLayer(IEntityRenderer<T, M> p_i50936_1_, A p_i50936_2_, A p_i50936_3_) {
        super(p_i50936_1_);
    ...
    private void renderArmorPiece(MatrixStack p_241739_1_, IRenderTypeBuffer p_241739_2_, T p_241739_3_, EquipmentSlotType p_241739_4_, int p_241739_5_, A p_241739_6_) {
        ...
        if (itemstack.getItem() instanceof ItemClothing) {
            ItemClothing clothing = (ItemClothing)itemstack.getItem();
            if (clothing.getSlot() == p_241739_4_) {
                ...
                int i = ((net.minecraft.item.IDyeableArmorItem)clothing).getColor(itemstack);
                float f = (float)(i >> 16 & 255) / 255.0F;
                float f1 = (float)(i >> 8 & 255) / 255.0F;
                float f2 = (float)(i & 255) / 255.0F;
                this.renderModel(p_241739_1_, p_241739_2_, p_241739_5_, flag1, p_241739_6_, f * colorR, f1 * colorG, f2 * colorB, this.getArmorResource(p_241739_3_, itemstack, p_241739_4_, null));
    ...
    protected void setPartVisibility(A p_188359_1_, EquipmentSlotType p_188359_2_) {
        p_188359_1_.setAllVisible(true);
        /*switch(p_188359_2_) {
            case HEAD:
    ...
    private ResourceLocation getArmorLocation(ArmorItem p_241737_1_, boolean p_241737_2_, @Nullable String type) {
        String s = "sevendaystomine:textures/models/clothing/" + p_241737_1_.getRegistryName().getPath() + (type == null ? "" : "_" + type) + ".png";
    ...
    public ResourceLocation getArmorResource(net.minecraft.entity.Entity entity, ItemStack stack, EquipmentSlotType slot, @Nullable String type) {
        ...
        String texture = item.getRegistryName().toString();
