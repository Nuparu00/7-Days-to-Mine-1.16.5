...
public class FeralZombieModel<T extends FeralZombieEntity> extends AgeableModel<T> implements IHasArm, IHasHead {
	...
	public FeralZombieModel() {
		this(0);
	}

	public FeralZombieModel(float scale) {
		texWidth = 64;
		texHeight = 64;

		head = new ModelRenderer(this);
		head.setPos(0.0F, 0.0F, 0.0F);
		head.texOffs(0, 16).addBox(-4.0F, -8.0F, -2.0F, 8.0F, 8.0F, 6.0F, 0.0F, false);
		head.texOffs(28, 18).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 6.0F, 2.0F, 0.0F, false);
		head.texOffs(0, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, 0.1F, false);
		head.texOffs(0, 61).addBox(-3.0F, -2.35F, -3.5F, 6.0F, 1.0F, 2.0F, 0.0F, false);

		leftArm = new ModelRenderer(this);
		leftArm.setPos(3.0F, 2.0F, 0.0F);
		leftArm.texOffs(32, 0).addBox(-1.0F, -2.0F, -2.0F, 4.0F, 14.0F, 4.0F, 0.0F, false);

		rightArm = new ModelRenderer(this);
		rightArm.setPos(-3.0F, 2.0F, 0.0F);
		rightArm.texOffs(0, 30).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 14.0F, 4.0F, 0.0F, false);

		rightLeg = new ModelRenderer(this);
		rightLeg.setPos(-2.0F, 12.0F, 0.0F);
		rightLeg.texOffs(16, 42).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.0F, false);

		leftLeg = new ModelRenderer(this);
		leftLeg.setPos(2.0F, 12.0F, 0.0F);
		leftLeg.texOffs(32, 42).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.0F, false);

		body = new ModelRenderer(this, 16, 16);
		body.texOffs(24, 26).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, 0.0F, false);
	}
