...
public class TwistedZombieModel<T extends TwistedZombieEntity> extends EntityModel<T> implements IHasArm, IHasHead {
    ...
    public TwistedZombieModel() {
        texWidth = 64;
        texHeight = 64;

        leftLeg = new ModelRenderer(this);
        leftLeg.setPos(2.0F, 12.0F, 0.0F);
        leftLeg.texOffs(44, 12).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.0F, false);

        rightLeg = new ModelRenderer(this);
        rightLeg.setPos(-2.0F, 12.0F, 0.0F);
        rightLeg.texOffs(16, 40).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.0F, false);

        rightArm = new ModelRenderer(this);
        rightArm.setPos(-4.0F, 2.0F, 0.0F);
        rightArm.texOffs(0, 32).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.0F, false);

        leftArm = new ModelRenderer(this);
        leftArm.setPos(4.0F, 2.0F, 0.0F);
        leftArm.texOffs(32, 0).addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.0F, false);
        leftArm.texOffs(12, 32).addBox(0.0F, -5.0F, 0.0F, 3.0F, 3.0F, 0.0F, 0.0F, false);
        leftArm.texOffs(32, 19).addBox(1.5F, -5.0F, -1.5F, 0.0F, 3.0F, 3.0F, 0.0F, false);
        ...
        head.texOffs(0, 0).addBox(-4.0F, -12.0F, 0.0F, 4.0F, 4.0F, 0.0F, 0.0F, false);
        head.texOffs(22, 35).addBox(0.0F, -11.0F, -2.0F, 3.0F, 3.0F, 0.0F, 0.0F, false);
        head.texOffs(32, 25).addBox(-7.0F, -7.0F, 0.0F, 3.0F, 3.0F, 0.0F, 0.0F, false);
        head.texOffs(29, 16).addBox(-7.0F, -5.5F, -1.5F, 3.0F, 0.0F, 3.0F, 0.0F, false);
        head.texOffs(12, 29).addBox(1.5F, -11.0F, -3.5F, 0.0F, 3.0F, 3.0F, 0.0F, false);
        head.texOffs(0, 0).addBox(-2.0F, -12.0F, -2.0F, 0.0F, 4.0F, 4.0F, 0.0F, false);

        body = new ModelRenderer(this);
        body.setPos(0.0F, 0.0F, 0.0F);
        body.texOffs(28, 28).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, 0.0F, false);
        body.texOffs(24, 16).addBox(-2.0F, 6.0F, 2.0F, 0.0F, 4.0F, 4.0F, 0.0F, false);
        body.texOffs(20, 0).addBox(-4.0F, 8.0F, 2.0F, 4.0F, 0.0F, 4.0F, 0.0F, false);
        body.texOffs(0, 12).addBox(0.0F, 3.0F, 2.0F, 0.0F, 4.0F, 4.0F, 0.0F, false);
        body.texOffs(20, 16).addBox(-2.0F, 5.0F, 2.0F, 4.0F, 0.0F, 4.0F, 0.0F, false);
        body.texOffs(16, 32).addBox(-2.0F, 1.0F, 2.0F, 0.0F, 3.0F, 3.0F, 0.0F, false);
        body.texOffs(0, 16).addBox(2.0F, 7.0F, 2.0F, 0.0F, 4.0F, 4.0F, 0.0F, false);
        body.texOffs(20, 4).addBox(0.0F, 9.0F, 2.0F, 4.0F, 0.0F, 4.0F, 0.0F, false);
        body.texOffs(29, 22).addBox(-3.5F, 2.5F, 2.0F, 3.0F, 0.0F, 3.0F, 0.0F, false);
        body.texOffs(29, 19).addBox(1.0F, 6.0F, 2.0F, 3.0F, 0.0F, 3.0F, 0.0F, false);
        body.texOffs(18, 29).addBox(2.5F, 4.5F, 2.0F, 0.0F, 3.0F, 3.0F, 0.0F, false);
    }
