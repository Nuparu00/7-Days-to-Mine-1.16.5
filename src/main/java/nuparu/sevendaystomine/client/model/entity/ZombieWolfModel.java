...
public class ZombieWolfModel<T extends ZombieWolfEntity>  extends TintedAgeableModel<T> {
    ...
    public void prepareMobModel(T p_212843_1_, float p_212843_2_, float p_212843_3_, float p_212843_4_) {
        //this.tail.yRot = (float) Math.sin(System.currentTimeMillis() / 100d);
