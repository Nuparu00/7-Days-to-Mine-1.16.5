...
public class ItemQualityHoe extends HoeItem implements IQuality, IToolLength{

	public EnumLength length = EnumLength.LONG;
	
	public ItemQualityHoe(IItemTier tier, int p_i231595_2_, float p_i48530_3_, Item.Properties properties) {
		super(tier, p_i231595_2_, p_i48530_3_, properties.tab(ItemGroup.TAB_TOOLS));
	}
	
	public ItemQualityHoe setAttackSpeed(double speed) {
	...
	public ItemQualityHoe setAttackDamage(float damage) {
	...
	public ItemQualityHoe setLength(EnumLength length) {
		this.length = length;
		return this;
	}
