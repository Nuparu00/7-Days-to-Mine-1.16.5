...
public class ItemQualityPickaxe extends PickaxeItem implements IQuality, IToolLength{

	public EnumLength length = EnumLength.LONG;
	
	public ItemQualityPickaxe(IItemTier tier, int p_i48478_2_, float p_i48530_3_, Item.Properties properties) {
		super(tier, p_i48478_2_, p_i48530_3_, properties.tab(ItemGroup.TAB_TOOLS));
	}
	
	/*public ItemQualityPickaxe setAttackSpeed(double speed) {
	...
	public ItemQualityPickaxe setAttackDamage(float damage) {
	...
	public ItemQualityPickaxe setLength(EnumLength length) {
		this.length = length;
		return this;
	}
