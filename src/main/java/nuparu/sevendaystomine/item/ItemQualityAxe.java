...
public class ItemQualityAxe extends AxeItem implements IQuality, IToolLength{

	public EnumLength length = EnumLength.LONG;
	
	public ItemQualityAxe(IItemTier tier, float p_i48530_2_, float p_i48530_3_, Item.Properties properties) {
		super(tier, p_i48530_2_, p_i48530_3_, properties.tab(ItemGroup.TAB_TOOLS));
	}
	
	public ItemQualityAxe setAttackSpeed(double speed) {
	...
	public ItemQualityAxe setAttackDamage(float damage) {
	...
	public ItemQualityAxe setLength(EnumLength length) {
		this.length = length;
		return this;
	}
