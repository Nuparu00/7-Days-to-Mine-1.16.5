...
public class FlameEntity extends ProjectileEntity {
    ...
    private static final DataParameter<Byte> PIERCE_LEVEL = EntityDataManager.defineId(FlameEntity.class, DataSerializers.BYTE);
    ...
    public FlameEntity(EntityType<FlameEntity> type, World p_i48546_2_) {
        super(type, p_i48546_2_);
    }

    public FlameEntity(World p_i48546_2_) {
        super(ModEntities.SHOT.get(), p_i48546_2_);
    }

    public FlameEntity(double p_i48547_2_, double p_i48547_4_, double p_i48547_6_, World p_i48547_8_) {
        this(ModEntities.FLAME.get(), p_i48547_8_);
        this.setPos(p_i48547_2_, p_i48547_4_, p_i48547_6_);
    }

    public FlameEntity(LivingEntity p_i48548_2_, World p_i48548_3_) {
    ...
    protected void onHitBlock(BlockRayTraceResult rayTraceResult) {
        ...
        Property property = getProperty(rayTraceResult.getDirection().getOpposite());
    ...
    public Property getProperty(Direction direction) {
        switch (direction) {
            case WEST:
                return FireBlock.WEST;
            case EAST:
                return FireBlock.EAST;
            case NORTH:
                return FireBlock.NORTH;
            case SOUTH:
                return FireBlock.SOUTH;
        }
        return null;
    }
