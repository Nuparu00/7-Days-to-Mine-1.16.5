...
public class FrigidHunterEntity<T extends FrigidHunterEntity> extends ZombieBipedEntity {

	public FrigidHunterEntity(EntityType<FrigidHunterEntity> type, World world) {
		super(type, world);
	}

	public FrigidHunterEntity(World world) {
	...
	public static AttributeModifierMap createAttributes() {
		return MonsterEntity.createMonsterAttributes().add(Attributes.FOLLOW_RANGE, 64.0D)
				.add(Attributes.MOVEMENT_SPEED, (double) 0.15F).add(Attributes.ATTACK_DAMAGE, 5.0D)
	...
	public class Factory implements IFactory<FrigidHunterEntity> {
		@Override
		public FrigidHunterEntity create(EntityType<FrigidHunterEntity> type, World world) {
