...
/*
    ...
    public int getZombiesInWave() {
        if (ServerConfig.bloodmoonFrequency.get() <= 0)
            return ServerConfig.wolfHordeZombiesPerWave.get();
        return (int) MathHelper.clampedLerp(ServerConfig.wolfHordeZombiesPerWave.get(),
                ServerConfig.wolfHordeZombiesPerWave.get(),
