package nuparu.sevendaystomine.world.gen.deserializers;
...
import nuparu.sevendaystomine.world.gen.processors.BookshelfProcessor;
...
public class ModJigsawPiece extends JigsawPiece {
    private static final Codec<Either<ResourceLocation, Template>> TEMPLATE_CODEC = Codec.of(ModJigsawPiece::encodeTemplate, ResourceLocation.CODEC.map(Either::left));
    public static final Codec<ModJigsawPiece> CODEC = RecordCodecBuilder.create((p_236841_0_) -> p_236841_0_.group(templateCodec(), processorsCodec(), projectionCodec()).apply(p_236841_0_, ModJigsawPiece::new));
    public final Either<ResourceLocation, Template> template;
    ...
    protected static <E extends ModJigsawPiece> RecordCodecBuilder<E, Supplier<StructureProcessorList>> processorsCodec() {
        return IStructureProcessorType.LIST_CODEC.fieldOf("processors").forGetter((p_236845_0_) -> p_236845_0_.processors);
    }

    protected static <E extends ModJigsawPiece> RecordCodecBuilder<E, Either<ResourceLocation, Template>> templateCodec() {
        return TEMPLATE_CODEC.fieldOf("location").forGetter((p_236842_0_) -> p_236842_0_.template);
    }

    protected ModJigsawPiece(Either<ResourceLocation, Template> p_i242008_1_, Supplier<StructureProcessorList> p_i242008_2_, JigsawPattern.PlacementBehaviour p_i242008_3_) {
        super(p_i242008_3_);
        this.template = p_i242008_1_;
        this.processors = p_i242008_2_;
    }

    public ModJigsawPiece(Template p_i242009_1_) {
    ...
    protected PlacementSettings getSettings(Rotation p_230379_1_, MutableBoundingBox p_230379_2_, boolean p_230379_3_) {
        ...
        placementsettings.addProcessor(BookshelfProcessor.INSTANCE);
        this.getProjection().getProcessors().forEach(placementsettings::addProcessor);
        return placementsettings;
    }

    public IJigsawDeserializer<?> getType() {
        return ModStructurePoolElements.MODDED;
    }
