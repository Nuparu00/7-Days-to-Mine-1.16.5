...
public class CargoShipSunkenStructure extends Structure<NoFeatureConfig> {
    /**
    ...
    public CargoShipSunkenStructure(Codec<NoFeatureConfig> codec) {
        super(codec);
    }
    ...
    public IStartFactory<NoFeatureConfig> getStartFactory() {
        return CargoShipSunkenStructure.Start::new;
    }
    ...
    protected boolean isFeatureChunk(ChunkGenerator chunkGenerator, BiomeProvider biomeSource, long seed, SharedSeedRandom chunkRandom, int chunkX, int chunkZ, Biome biome, ChunkPos chunkPos, NoFeatureConfig featureConfig) {
        ...
        do {
            if (!var11.hasNext()) {
                var11 = biomeSource.getBiomesWithin(chunkX * 16 + 9, chunkGenerator.getSeaLevel(), chunkZ * 16 + 9, 29).iterator();
                ...
                do {
                    ...
                    biome1 = (Biome)var11.next();
                } while(biome1.getBiomeCategory() == Biome.Category.OCEAN || biome1.getBiomeCategory() == Biome.Category.RIVER);

                return false;
            }

            biome1 = (Biome)var11.next();
        } while(biome1.getGenerationSettings().isValidStart(this));

        return false;
    }

    private boolean isNearCruiser(ChunkGenerator p_242782_1_, long p_242782_2_, SharedSeedRandom p_242782_4_, int p_242782_5_, int p_242782_6_) {
        StructureSeparationSettings structureseparationsettings = p_242782_1_.getSettings().getConfig(ModStructureFeatures.CRUISER.get());
        if (structureseparationsettings == null) {
            return false;
        } else {
            for(int i = p_242782_5_ - 12; i <= p_242782_5_ + 12; ++i) {
                for(int j = p_242782_6_ - 12; j <= p_242782_6_ + 12; ++j) {
                    ChunkPos chunkpos = ModStructureFeatures.CRUISER.get().getPotentialFeatureChunk(structureseparationsettings, p_242782_2_, p_242782_4_, i, j);
        ...
        public void generatePieces(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn, NoFeatureConfig config) {
            ...
            JigsawManager.addPieces(
                    ...
                    new VillageConfig(() -> dynamicRegistryManager.registryOrThrow(Registry.TEMPLATE_POOL_REGISTRY)
                            ...
                            .get(new ResourceLocation(SevenDaysToMine.MODID, "scattered/cargo_ship_sunken/cargo_ship_sunken_pool")),
            ...
            int yOffset = chunkGenerator.getFirstOccupiedHeight(structureCenter.getX(),structureCenter.getZ(), Heightmap.Type.OCEAN_FLOOR_WG) - this.pieces.get(0).getBoundingBox().y0;
            for (StructurePiece structurePiece : this.pieces) {
                structurePiece.move(xOffset, yOffset, zOffset);
            }
