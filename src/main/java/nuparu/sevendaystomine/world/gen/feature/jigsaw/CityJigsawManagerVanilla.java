                                ...
                                if (optional1.isPresent() && (((JigsawPattern)optional1.get()).size() != 0 || Objects.equals(resourcelocation1, JigsawPatternRegistry.EMPTY.location()))) {
                                    ...
                                    if (flag1) {
                                        ...
                                        if (mutableobject.getValue() == null) {
                                            mutableobject.setValue(VoxelShapes.create(AxisAlignedBB.of(mutableboundingbox.moved(0,-mutableboundingbox.y0,0))));
                                        }
                                    } else {
                                    ...
                                    while(var29.hasNext()) {
                                        ...
                                        while(var31.hasNext()) {
                                            ...
                                            do {
                                                ...
                                                mutableboundingbox2.move(0,-mutableboundingbox2.y0,0);
                                                j1 = mutableboundingbox2.y0;
                                                mutableboundingbox3Y = mutableboundingbox3.y0;
                                                mutableboundingbox3 = mutableboundingbox3.moved(0,-mutableboundingbox3.y0,0);
                                            ...
                                            mutableboundingbox3 = mutableboundingbox3.moved(0,mutableboundingbox3Y,0);
                                            ...
                                            if (p_236831_4_ + 1 <= this.maxDepth) {
                                                this.placing.addLast(new CityJigsawManagerVanilla.Entry(abstractvillagepiece, mutableobject1, l, p_236831_4_ + 1));
                                            }
                                            continue label94;
                                        }
                                    }
                                } else {
                                    CityJigsawManagerVanilla.LOGGER.warn("Empty or none existent fallback pool: {}", resourcelocation1);
                                }
                            } else {
                                CityJigsawManagerVanilla.LOGGER.warn("Empty or none existent pool: {}", resourcelocation);
                            }
                        }
