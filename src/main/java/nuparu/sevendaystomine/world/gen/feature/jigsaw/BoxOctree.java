...
/*
BoxOctree by TelepathicGrunt
https://github.com/TelepathicGrunt/RepurposedStructures/blob/latest-released/src/main/java/com/telepathicgrunt/repurposedstructures/utils/BoxOctree.java
 */
public class BoxOctree {
    ...
    private void subdivide() {
        if (!childrenOctants.isEmpty()) {
            throw new UnsupportedOperationException(SevenDaysToMine.MODID + " - Tried to subdivide when there are already children octants.");
        }
