...
public class CemeteryBuilding extends Building{
    ...
    public CemeteryBuilding(int weight) {
        this(weight, 0);
    }

    public CemeteryBuilding(int weight, int yOffset) {
        super(new ResourceLocation(SevenDaysToMine.MODID, "cemetery"), weight, yOffset);
