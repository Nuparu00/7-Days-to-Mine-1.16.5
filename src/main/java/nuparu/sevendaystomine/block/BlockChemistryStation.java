...
public class BlockChemistryStation extends BlockHorizontalBase {

	public BlockChemistryStation(AbstractBlock.Properties properties) {
		super(properties);
	}
	...
	public void onRemove(BlockState state, World world, BlockPos blockPos, BlockState newState, boolean isMoving) {
		if (state.getBlock() != newState.getBlock()) {
			...
			if (tileentity instanceof TileEntityChemistryStation) {
				TileEntityChemistryStation te = (TileEntityChemistryStation) tileentity;
