...
public class BlockCashRegister extends BlockHorizontalBase implements IScrapable, IWaterLoggable {
	...
	public BlockCashRegister(AbstractBlock.Properties properties) {
