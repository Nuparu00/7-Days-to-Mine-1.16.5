...
public class BlockCoffeePlant extends BushBlock implements IGrowable{

    public static final IntegerProperty AGE = BlockStateProperties.AGE_7;
	private static final VoxelShape[] SHAPE_BY_AGE = new VoxelShape[] {Block.box(0.0D, 0.0D, 0.0D, 1.0D, 0.125D, 1.0D), Block.box(0.0D, 0.0D, 0.0D, 1.0D, 0.25D, 1.0D), Block.box(0.0D, 0.0D, 0.0D, 1.0D, 0.375D, 1.0D), Block.box(0.0D, 0.0D, 0.0D, 1.0D, 0.5D, 1.0D), Block.box(0.0D, 0.0D, 0.0D, 1.0D, 0.625D, 1.0D), Block.box(0.0D, 0.0D, 0.0D, 1.0D, 0.75D, 1.0D), Block.box(0.0D, 0.0D, 0.0D, 1.0D, 0.875D, 1.0D), Block.box(0.0D, 0.0D, 0.0D, 1.0D, 1.0D, 1.0D)};
	...
	protected IItemProvider getBaseSeedId() {
		return ModItems.COFFEE_BERRY.get();
	}
