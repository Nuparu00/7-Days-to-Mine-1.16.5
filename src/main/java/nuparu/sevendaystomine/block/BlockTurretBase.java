...
public class BlockTurretBase extends BlockHorizontalBase implements IScrapable {
	...
	public BlockTurretBase(AbstractBlock.Properties properties) {
	...
	public void onRemove(BlockState state, World world, BlockPos blockPos, BlockState newState, boolean isMoving) {
		if (state.getBlock() != newState.getBlock()) {
			...
			if (tileentity instanceof TileEntityTurretBase) {
				TileEntityTurretBase te = (TileEntityTurretBase) tileentity;
