...
public class BlockPhoto extends BlockHorizontalBase implements IScrapable {
	...
	private static final VoxelShape NORTH = Block.box(0.0F, 0.0F, 0.9625F, 1.0F, 1F, 1F);
	private static final VoxelShape SOUTH = Block.box(0.0F, 0.0F, 0.0F, 1.0F, 1F, 0.0375F);
	private static final VoxelShape WEST = Block.box(0.9625F, 0.0F, 0F, 1F, 1F, 1F);
	private static final VoxelShape EAST = Block.box(0.0F, 0.0F, 0.0F, 0.0375F, 1F, 1F);
