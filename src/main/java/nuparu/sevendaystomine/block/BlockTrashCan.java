...
public class BlockTrashCan extends BlockHorizontalBase implements IScrapable, IWaterLoggable {
	public static final BooleanProperty WATERLOGGED = BlockStateProperties.WATERLOGGED;
	
	private static final VoxelShape SHAPE = Block.box(0.125F*16, 0.0F, 0.1255F*16, 0.875F*16, 0.8125F*16, 0.875F*16);
	
	private EnumMaterial material = EnumMaterial.IRON;
	private int weight = 2;

	public BlockTrashCan(AbstractBlock.Properties properties) {
		super(properties);
