...
public class CampfireRecipeManager {
	...
	public void addRecipes() {
		...
		addRecipe(new CampfireRecipeShapeless(new ItemStack(ModItems.BOTTLED_WATER.get(),3),new ItemStack(ModBlocks.COOKING_POT),new ArrayList(Arrays.asList(new ItemStack(ModItems.BOTTLED_MURKY_WATER.get()),new ItemStack(ModItems.BOTTLED_MURKY_WATER.get()),new ItemStack(ModItems.BOTTLED_MURKY_WATER.get())))));
		addRecipe(new CampfireRecipeShapeless(new ItemStack(ModItems.BOTTLED_WATER.get(),4),new ItemStack(ModBlocks.COOKING_POT),new ArrayList(Arrays.asList(new ItemStack(ModItems.BOTTLED_MURKY_WATER.get()),new ItemStack(ModItems.BOTTLED_MURKY_WATER.get()),new ItemStack(ModItems.BOTTLED_MURKY_WATER.get()),new ItemStack(ModItems.BOTTLED_MURKY_WATER.get())))));
		addRecipe(new CampfireRecipeShapeless(new ItemStack(ModItems.CANNED_WATER.get()),new ItemStack(ModBlocks.COOKING_POT),new ArrayList(Arrays.asList(new ItemStack(ModItems.CANNED_MURKY_WATER.get())))));
		addRecipe(new CampfireRecipeShapeless(new ItemStack(ModItems.CANNED_WATER.get(),2),new ItemStack(ModBlocks.COOKING_POT),new ArrayList(Arrays.asList(new ItemStack(ModItems.CANNED_MURKY_WATER.get()),new ItemStack(ModItems.CANNED_MURKY_WATER.get())))));
		addRecipe(new CampfireRecipeShapeless(new ItemStack(ModItems.CANNED_WATER.get(),3),new ItemStack(ModBlocks.COOKING_POT),new ArrayList(Arrays.asList(new ItemStack(ModItems.CANNED_MURKY_WATER.get()),new ItemStack(ModItems.CANNED_MURKY_WATER.get()),new ItemStack(ModItems.CANNED_MURKY_WATER.get())))));
		addRecipe(new CampfireRecipeShapeless(new ItemStack(ModItems.CANNED_WATER.get(),4),new ItemStack(ModBlocks.COOKING_POT),new ArrayList(Arrays.asList(new ItemStack(ModItems.CANNED_MURKY_WATER.get()),new ItemStack(ModItems.CANNED_MURKY_WATER.get()),new ItemStack(ModItems.CANNED_MURKY_WATER.get()),new ItemStack(ModItems.CANNED_MURKY_WATER.get())))));
		addRecipe(new CampfireRecipeShapeless(new ItemStack(ModItems.BOTTLED_COFFEE.get()),new ItemStack(ModBlocks.COOKING_POT),new ArrayList(Arrays.asList(new ItemStack(ModItems.BOTTLED_WATER.get()),new ItemStack(ModItems.COFFEE.get()_BEANS)))));
		addRecipe(new CampfireRecipeShapeless(new ItemStack(ModItems.BOTTLED_COFFEE.get(),2),new ItemStack(ModBlocks.COOKING_POT),new ArrayList(Arrays.asList(new ItemStack(ModItems.BOTTLED_WATER.get()),new ItemStack(ModItems.COFFEE.get()_BEANS),new ItemStack(ModItems.BOTTLED_WATER.get()),new ItemStack(ModItems.COFFEE.get()_BEANS)))));
		addRecipe(new CampfireRecipeShapeless(new ItemStack(ModItems.GOLDENROD_TEA),new ItemStack(ModBlocks.COOKING_POT),new ArrayList(Arrays.asList(new ItemStack(ModItems.BOTTLED_WATER.get()),new ItemStack(ModBlocks.GOLDENROD)))));
		addRecipe(new CampfireRecipeShapeless(new ItemStack(ModItems.GOLDENROD_TEA),new ItemStack(ModBlocks.COOKING_POT),new ArrayList(Arrays.asList(new ItemStack(ModItems.BOTTLED_WATER.get()),new ItemStack(ModBlocks.GOLDENROD),new ItemStack(ModItems.BOTTLED_WATER.get()),new ItemStack(ModBlocks.GOLDENROD)))));
		...
		addRecipe(new CampfireRecipeShapeless(new ItemStack(ModItems.ANTIBIOTICS),new ItemStack(ModBlocks.BEAKER),new ArrayList(Arrays.asList(new ItemStack(ModItems.MOLDY_BREAD),new ItemStack(ModItems.POTASSIUM,2),new ItemStack(ModItems.BOTTLED_WATER.get())))));
		addRecipe(new CampfireRecipeShapeless(new ItemStack(ModItems.COFFEE.get()_BEANS),new ItemStack(ModBlocks.COOKING_POT),new ArrayList(Arrays.asList(new ItemStack(ModItems.COFFEE.get()_BERRY)))));
		addRecipe(new CampfireRecipeShapeless(new ItemStack(ModItems.COFFEE.get()_BEANS,2),new ItemStack(ModBlocks.COOKING_POT),new ArrayList(Arrays.asList(new ItemStack(ModItems.COFFEE.get()_BERRY),new ItemStack(ModItems.COFFEE.get()_BERRY)))));
		addRecipe(new CampfireRecipeShapeless(new ItemStack(ModItems.COFFEE.get()_BEANS,3),new ItemStack(ModBlocks.COOKING_POT),new ArrayList(Arrays.asList(new ItemStack(ModItems.COFFEE.get()_BERRY),new ItemStack(ModItems.COFFEE.get()_BERRY),new ItemStack(ModItems.COFFEE.get()_BERRY)))));
		addRecipe(new CampfireRecipeShapeless(new ItemStack(ModItems.COFFEE.get()_BEANS,4),new ItemStack(ModBlocks.COOKING_POT),new ArrayList(Arrays.asList(new ItemStack(ModItems.COFFEE.get()_BERRY),new ItemStack(ModItems.COFFEE.get()_BERRY),new ItemStack(ModItems.COFFEE.get()_BERRY),new ItemStack(ModItems.COFFEE.get()_BERRY)))));
		*/
