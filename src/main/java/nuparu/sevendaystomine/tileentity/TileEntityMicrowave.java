...
public class TileEntityMicrowave extends TileEntityItemHandler<ItemHandlerNameable>{

	private static final int INVENTORY_SIZE = 1;
	private static final ITextComponent DEFAULT_NAME = new TranslationTextComponent("container.microwave");
	
	public TileEntityMicrowave() {
		super(ModTileEntities.MICROWAVE.get());
	}
