...
public class TileEntityMedicalCabinet extends TileEntityItemHandler<ItemHandlerNameable>{

	private static final int INVENTORY_SIZE = 9;
	private static final ITextComponent DEFAULT_NAME = new TranslationTextComponent("container.medical");
	
	public TileEntityMedicalCabinet() {
		super(ModTileEntities.MEDICAL_CABINET.get());
	}
