...
public class TileEntityCardboard extends TileEntityItemHandler<ItemHandlerNameable> {

	private static final int INVENTORY_SIZE = 9;
	private static final ITextComponent DEFAULT_NAME = new TranslationTextComponent("container.cardboard");

	public TileEntityCardboard() {
		super(ModTileEntities.CARDBOARD.get());
	}
