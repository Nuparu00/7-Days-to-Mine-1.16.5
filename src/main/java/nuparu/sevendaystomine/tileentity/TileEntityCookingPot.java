...
import nuparu.sevendaystomine.crafting.pot.ICookingPotRecipe;
...
public class TileEntityCookingPot extends TileEntityItemHandler<ItemHandlerNameable>
		implements INamedContainerProvider, IContainerCallbacks, ITickableTileEntity, IInventory {

	public static final ITextComponent DEFAULT_NAME = new TranslationTextComponent("container.cooking_pot");
	...
	public final IIntArray dataAccess = new IIntArray() {
		public int get(int p_221476_1_) {
			switch (p_221476_1_) {
			case 0:
				return TileEntityCookingPot.this.cookTime;
			case 1:
				return TileEntityCookingPot.this.totalCookTime;
			default:
				return 0;
			}
		}
		...
		public void set(int p_221477_1_, int p_221477_2_) {
			switch (p_221477_1_) {
			case 0:
				TileEntityCookingPot.this.cookTime = p_221477_2_;
				break;
			case 1:
				TileEntityCookingPot.this.totalCookTime = p_221477_2_;
				break;
			}
	...
	private ICookingPotRecipe<TileEntityCookingPot> currentRecipe = null;



	public TileEntityCookingPot() {
		super(ModTileEntities.COOKING_POT.get());
	...
	private boolean canSmelt() {
		...
		ICookingPotRecipe<TileEntityCookingPot> irecipe = this.level.getRecipeManager().getRecipeFor(ModRecipeSerializers.COOKING_POT.getA(), this, this.level).orElse(null);
	...
	public List<IRecipe<?>> getRecipesToAwardAndPopExperience(World p_235640_1_, Vector3d p_235640_2_) {
		...
		for(Object2IntMap.Entry<ResourceLocation> entry : this.recipesUsed.object2IntEntrySet()) {
			p_235640_1_.getRecipeManager().byKey(entry.getKey()).ifPresent((p_235642_4_) -> {
				...
				createExperience(p_235640_1_, p_235640_2_, entry.getIntValue(), ((ICookingPotRecipe<TileEntityCookingPot>)p_235642_4_).getExperience());
			});
		}
	...
	public Container createMenu(int windowID, PlayerInventory playerInventory, PlayerEntity playerEntity) {
		return ContainerCookingPot.createContainerServerSide(windowID, playerInventory, this);
	}
