...
public class TileEntityBeaker extends TileEntityItemHandler<ItemHandlerNameable>
		implements INamedContainerProvider, IContainerCallbacks, ITickableTileEntity, IInventory {

	public static final ITextComponent DEFAULT_NAME = new TranslationTextComponent("container.beaker");
	...
	public final IIntArray dataAccess = new IIntArray() {
		public int get(int p_221476_1_) {
			switch (p_221476_1_) {
			case 0:
				return TileEntityBeaker.this.cookTime;
			case 1:
				return TileEntityBeaker.this.totalCookTime;
			default:
				return 0;
			}
		}
		...
		public void set(int p_221477_1_, int p_221477_2_) {
			switch (p_221477_1_) {
			case 0:
				TileEntityBeaker.this.cookTime = p_221477_2_;
				break;
			case 1:
				TileEntityBeaker.this.totalCookTime = p_221477_2_;
				break;
			}
	...
	private IBeakerRecipe<TileEntityBeaker> currentRecipe = null;



	public TileEntityBeaker() {
		super(ModTileEntities.BEAKER.get());
	...
	private boolean canSmelt() {
		...
		IBeakerRecipe<TileEntityBeaker> irecipe = this.level.getRecipeManager().getRecipeFor(ModRecipeSerializers.BEAKER.getA(), this, this.level).orElse(null);
	...
	public List<IRecipe<?>> getRecipesToAwardAndPopExperience(World p_235640_1_, Vector3d p_235640_2_) {
		...
		for(Object2IntMap.Entry<ResourceLocation> entry : this.recipesUsed.object2IntEntrySet()) {
			p_235640_1_.getRecipeManager().byKey(entry.getKey()).ifPresent((p_235642_4_) -> {
				...
				createExperience(p_235640_1_, p_235640_2_, entry.getIntValue(), ((IBeakerRecipe)p_235642_4_).getExperience());
			});
		}
	...
	public Container createMenu(int windowID, PlayerInventory playerInventory, PlayerEntity playerEntity) {
		return ContainerBeaker.createContainerServerSide(windowID, playerInventory, this);
	}
