...
public static void register(CommandDispatcher<CommandSource> dispatcher) {
	LiteralArgumentBuilder<CommandSource> mbesayCommand = Commands.literal("locatemodded")
			.requires((commandSource) -> commandSource.hasPermission(2)).then(Commands.argument("pos", BlockPosArgument.blockPos())).then(Commands.argument("maxdistance", MessageArgument.message()).executes((p_198539_0_) -> cure(p_198539_0_, BlockPosArgument.getOrLoadBlockPos(p_198539_0_, "pos"))));
