...
public class UncraftingInventory implements IInventory, IRecipeHelperPopulator {
    private final NonNullList<ItemStack> items;
    private final int width;
    private final int height;
    private final Container menu;

    public UncraftingInventory(Container p_i1807_1_, int p_i1807_2_, int p_i1807_3_) {
