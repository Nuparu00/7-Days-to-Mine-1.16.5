...
public class ContainerWorkbenchUncrafting extends Container {
    ...
    protected ContainerWorkbenchUncrafting(int windowID, PlayerInventory invPlayer, TileEntityItemHandler<ItemHandlerNameable> tileEntity, BlockPos pos) {
    ...
    public static ContainerWorkbenchUncrafting createContainerClientSide(int windowID, PlayerInventory playerInventory, PacketBuffer packetBuffer) {
        ...
        return new ContainerWorkbenchUncrafting(windowID,playerInventory, (TileEntityItemHandler<ItemHandlerNameable>) playerInventory.player.level.getBlockEntity(pos),pos);
    }

    public static ContainerWorkbenchUncrafting createContainerServerSide(int windowID, PlayerInventory playerInventory, TileEntityItemHandler<ItemHandlerNameable> tileEntity, BlockPos pos){
