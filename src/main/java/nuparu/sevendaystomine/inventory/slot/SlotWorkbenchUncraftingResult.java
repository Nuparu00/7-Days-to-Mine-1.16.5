...
public class SlotWorkbenchUncraftingResult extends Slot {
    ...
    public SlotWorkbenchUncraftingResult(PlayerEntity p_i45790_1_, UncraftingInventory p_i45790_2_, IInventory p_i45790_3_, int p_i45790_4_, int p_i45790_5_, int p_i45790_6_,ContainerWorkbenchUncrafting container) {
    ...
    public ItemStack onTake(PlayerEntity p_190901_1_, ItemStack p_190901_2_) {
        ...
        if (!itemstack.isEmpty())
        {
            ...
            ItemStack scrap = container.getTileEntity().getInventory().getStackInSlot(0);
            if(scrap.getCount() > 1) {
                scrap.shrink(1);
            }
            else {
                container.getTileEntity().getInventory().setStackInSlot(0,ItemStack.EMPTY);
