...
public class ModLootTables {
	...
	public static final ResourceLocation AIRDROP = new ResourceLocation(SevenDaysToMine.MODID,"entities/airdrop");
	...
	public static final ResourceLocation GARBAGE = new ResourceLocation(SevenDaysToMine.MODID,"containers/garbage/garbage");
	...
	public static final ResourceLocation SEDAN = new ResourceLocation(SevenDaysToMine.MODID,"containers/sedan/sedan");
	...
	public static final ResourceLocation ZOMBIE_GENERIC = new ResourceLocation(SevenDaysToMine.MODID,"entities/zombie_generic");
	...
	public static final ResourceLocation POLICE_CAR = new ResourceLocation(SevenDaysToMine.MODID,"containers/police_car/police_car");
	public static final ResourceLocation TOILET_SALVAGE = new ResourceLocation(SevenDaysToMine.MODID,"salvage/toilet");
	public static final ResourceLocation CAR_SALVAGE = new ResourceLocation(SevenDaysToMine.MODID,"salvage/car");
	public static final ResourceLocation RADIATOR_SALVAGE = new ResourceLocation(SevenDaysToMine.MODID,"salvage/radiator");
	public static final ResourceLocation SINK_FAUCET_SALVAGE = new ResourceLocation(SevenDaysToMine.MODID,"salvage/sink_faucet");
	public static final ResourceLocation SHOWER_HEAD_SALVAGE = new ResourceLocation(SevenDaysToMine.MODID,"salvage/shower_head");
